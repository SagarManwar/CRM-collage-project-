...
$mail->SMTPAuth = true;
$mail->Username = 'lsagarmanwar@gmail.com';
$mail->Password = 'lfgznqznjtbobrey';
$mail->SMTPSecure = 'ssl';
$mail->Port = 465;

$mail->setFrom('lsagarmanwar@gmail.com');

$mail->addAddress($_POST["email"]);
$mail->isHTML(true);

$mail->Subject = "Mail Sent hua Lavde";
$mail->Body = " Ye mail php se bheja hai ";
  ...
  <div class="login-container">  
        ...
        <div class="col-md-5 "> <br>
          <form id="signup" name="signup" class="login-form" onsubmit="return checkpass();" method="post">
            ...
            <div class="form-group">
              <label for="phone" class="control-label">Contact Number1</label>
